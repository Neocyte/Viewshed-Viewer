 ...
 * Citation: 
 * 
 * IshanDemon. 2015. List_Country_State.
 * https://github.com/IshanDemon/List_Country_State. (2021).
 * 
 */
...
function populateStates( countryElementId, stateElementId, dataState ){
	...
	for (var i=0; i<state_arr.length; i++) {
        ...
        {
            if(stateElement.options[i].value === dataState )
            {
...
function populateCountries(countryElementId, stateElementId, dataCountry, dataState) {
	...
	// Assigned all countries. Now assign event listener for the states.
        ...
        {
            if(countryElement.options[i].value === dataCountry )
            {
        ...
        if(dataState !== "")
        {
            populateStates( countryElementId, stateElementId, dataState );
        }
	if( stateElementId ){
