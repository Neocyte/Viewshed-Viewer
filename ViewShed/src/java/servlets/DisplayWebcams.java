...
/**
 * Returns all webcams belonging to current user in a string that creates
 * an HTML table of the data
 * 
 * @author Karissa Jelonek (2021)
 */

// Extend HttpServlet class
@WebServlet(name = "DisplayWebcams", urlPatterns = {"/DisplayWebcams"})
public class DisplayWebcams extends HttpServlet {
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response)
      throws ServletException, IOException {
        ...
        //Setting JSP page
        String page = "/jsp/userWebcams.jsp";
        ...
        Collection<Webcam> c = wm.getWebcamsByUserNumber(user.getUserNumber(), offset);
        returnString = getHtmlTableFromWebcamCollection(c, request, cpn);
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        *  webcam data
        */  
        public static String getHtmlTableFromWebcamCollection(Collection<Webcam> c,
                HttpServletRequest request, int cpn)
        {
            ...
            String formAction = "EditWebcamForm";
            ...
            //Form to dispay next or previous page of webcams
            returnString += "<form style='text-align: center; width: 100%; box-sizing: border-box;' method='POST' action='DisplayWebcams'>";
            if(npn != 1) {
